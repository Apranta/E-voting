            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link waves-effect font-weight-normal active" href="<?= site_url('panitia') ?>">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link waves-effect font-weight-normal active" href="<?= site_url('panitia/finalis') ?>">Daftar Finalis</a>
                        </li>
                        <li class="nav-item">
