        ...
        <div class="sidebar-fixed position-fixed border-right bg-transparent" style="background-image: url('<?= base_url() ?>assets/img/background.png'); background-size: contain;">
            ...
            <div class="list-group list-group-flush">
                <a href="<?= site_url('panitia') ?>" class="list-group-item font-weight-normal list-group-item-action waves-effect <?php if($active == 0) echo "active"; ?>">
                    <i class="fas fa-home mr-3"></i> Dashboard
                </a>
                <a href="<?= site_url('panitia/finalis') ?>" class="list-group-item font-weight-normal list-group-item-action waves-effect <?php if($active == 1) echo "active"; ?>">
